        ...
        <div class="row">
            <div class="col-12">
                <h1>Companies</h1>
                        ...
                        $lastPage = ceil($countAllCompanies / $perPage);
                        ...
                        $sqliQuery = "$selectCompaniesQuery LIMIT " . ($page - 1) * $perPage . ", $perPage";
                        ...
                        while ($company = $res->fetch_assoc()) {
                            ...
                            $id = $company['ID'];
                            $name = $company['NAME'];
                            $registrationDate = date_format(date_create($company['REG_DATE']),"d F Y");

                            $deactivationDate = "";
                            if (isset($company['DEACTIVATED_DATE'])) {
                                $deactivationDate = " - " . date_format(date_create($company['DEACTIVATED_DATE']), "d F Y");
                            }

                            $contacts = "";
                            if ($company['PHONE']){
                                $phone = $company['PHONE'];
                                $contacts = "<i class=\"fa fa-phone\" aria-hidden=\"true\"></i> <a href='tel:$phone'>$phone</a><br>";
                            } else {
                                $contacts = "<i class=\"fa fa-phone\" aria-hidden=\"true\"></i> N/A<br>";
                            }

                            if ($company['EMAIL']){
                                $email = $company['EMAIL'];
                                $contacts = $contacts . "<i class=\"fa fa-envelope\" aria-hidden=\"true\"></i> <a href='mailto:$email'>$email</a><br>";
                            } else {
                                $contacts = $contacts . "<i class=\"fa fa-envelope\" aria-hidden=\"true\"></i> N/A<br>";
                            }

                            if ($company['WEBSITE']){
                                $website = $company['WEBSITE'];
                                $contacts = $contacts . "<i class=\"fa fa-globe\" aria-hidden=\"true\"></i> <a href='$website'>$website</a><br>";
                            } else {
                                $contacts = $contacts . "<i class=\"fa fa-globe\" aria-hidden=\"true\"></i> N/A<br>";
                            ...
                            echo "
								<tr>
									<td>
										<a href=\"companyManagement.php?company-id=$id\">
											<div class=\"row\">
												<div class=\"col-md-12\"><b>$name</b></div>
												<div class=\"col-md-12\">Active: $registrationDate $deactivationDate</div>
											</div>
											<div class=\"row\">
                        ...
                        if ($lastPage != 1) {
                            if ($page != 1) {
                                ...
                                $prevP = "
                                    ...
                                    <a href=\"companies.php?page=$prev\" aria-controls=\"dataTable\" data-dt-idx=\"0\" tabindex=\"0\" class=\"page-link\">Previous</a>
                                    </li>";
                            }
                            if ($page != $lastPage) {
                                $next = $page + 1;
                                $nextP = "
                                    ...
                                    <a href=\"companies.php?page=$next\" aria-controls=\"dataTable\" data-dt-idx=\"$lastPage.1\" tabindex=\"0\" class=\"page-link\">Next</a></li>
                                    </ul>";
                            }
                        ...
                        for ($countPage = 0; $countPage < $lastPage; $countPage++) {
                            ...
                            if ($page == $pageNum) {
                                $pagination .= "
                                    ...
                                    <a href=\"companies.php?page=$pageNum\" aria-controls=\"dataTable\" data-dt-idx=\"$pageNum\" tabindex=\"0\" class=\"page-link\">$pageNum</a>
                                    </li>";
                            } else {
                                $pagination .= "
