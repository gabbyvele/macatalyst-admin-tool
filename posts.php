    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                $sqliQuery = "$selectPostsQuery LIMIT " . ($page - 1) * $perPage . ", $perPage";
                ...
                while ($post = $res->fetch_assoc()) {
                    ...
                    $date = date_format(date_create($post['TIMESTAMP']), "d F Y");
                    $type = $post['TYPE_NAME'];
                    $active;
                    if ($post['ACTIVE'] == 0) {
                ...
                echo "</table>
                      <table>
                      <tr><td><i class=\"fa fa-check-circle-o\" aria-hidden=\"true\"></i> - Active News</td></tr>
                      <tr><td><i class=\"fa fa-window-close\" aria-hidden=\"true\"></i> - Inactive Post</td></tr>
                      </table>
                      &nbsp";
