    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                ...
                $lastPage = ceil($countAllNews / $perPage);
                ...
                $sqliQuery = "$selectNewsQuery LIMIT " . ($page - 1) * $perPage . ", $perPage";
                ...
                while ($news = $res->fetch_assoc()) {
                    ...
                    if ($news['Breaking_news'] == 1) {
                        $breakingNews = "<i class=\"fa fa-exclamation-triangle\" aria-hidden=\"true\"></i>";
                    } else {
                        $breakingNews = "<i class=\"fa fa-newspaper-o\" aria-hidden=\"true\"></i>";
                    }

                    echo "
						<tr>
							<td>
								<a href=\"newsManagement.php?news-id=$id\">
									<div class=\"row\">
										<div class=\"col-md-4 d-none d-sm-block\">
										    <img src=\"../images/$image\" height=\"100\" alt=\"Image preview...\">
                                        </div>
										<div class=\"col-md-8 col-sm-12\"><b>$breakingNews | </b> $headline<br>
										    <b>Industry: </b>$industry<br>
										    <b>Author: </b>$author<br>
										    <b>Created By: </b>$createdBy<br>
										    <b>Created: </b>$date<br>
										    <i class=\"fa fa-eye\" aria-hidden=\"true\"></i> $views<br>
										</div>
									</div>
								</a>
							</td>
                ...
                echo "</table>
                      <table>
                      <tr><td><i class=\"fa fa-exclamation-triangle\" aria-hidden=\"true\"></i> - Breaking News</td></tr>
                      <tr><td><i class=\"fa fa-newspaper-o\" aria-hidden=\"true\"></i> - Normal News</td></tr>
                      <tr><td><i class=\"fa fa-eye\" aria-hidden=\"true\"></i> - Views</td></tr>
                      </table>
                      &nbsp";

                $prevP = "<li class=\"paginate_button page-item previous disabled\" id=\"dataTable_previous\">
                          <a href=\"#\" aria-controls=\"dataTable\" data-dt-idx=\"0\" tabindex=\"0\" class=\"page-link\">Previous</a>
                          </li>";

                $nextP = "<li class=\"paginate_button page-item next disabled\" id=\"dataTable_next\">
                ...
                if ($lastPage != 1) {
                    if ($page != 1) {
                        $prev = $page - 1;
                        $prevP = "<li class=\"paginate_button page-item previous\" id=\"dataTable_previous\">
                                  <a href=\"newss.php?page=$prev\" aria-controls=\"dataTable\" data-dt-idx=\"0\" tabindex=\"0\" class=\"page-link\">Previous</a>
                                  </li>";
                    }
                    if ($page != $lastPage) {
                        $next = $page + 1;
                        $nextP = "<li class=\"paginate_button page-item next\" id=\"dataTable_next\">
                                  <a href=\"newss.php?page=$next\" aria-controls=\"dataTable\" data-dt-idx=\"$lastPage.1\" tabindex=\"0\" class=\"page-link\">Next</a></li>
                                  </ul>";
                    }
                ...
                for ($countPage = 0; $countPage < $lastPage; $countPage++) {
                    ...
                    if ($page == $pageNum) {
                        $pagination .= "<li class=\"paginate_button page-item active\">
                                        <a href=\"news.php?page=$pageNum\" aria-controls=\"dataTable\" data-dt-idx=\"$pageNum\" tabindex=\"0\" class=\"page-link\">$pageNum</a>
                                        </li>";
                    } else {
